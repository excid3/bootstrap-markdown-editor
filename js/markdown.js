...
(function () {
    ...
    // http://meta.stackoverflow.com/questions/64655/strange-bme-bug
...
(function () {
    ...
    function PanelCollection(postfix) {
        this.buttonBar = doc.getElementById("bme-button-bar" + postfix);
        this.preview = doc.getElementById("bme-preview" + postfix);
        this.input = doc.getElementById("bme-input" + postfix);
    };
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttonRow.id = "bme-button-row" + postfix;
            ...
            var makeGroup = function (num) {
                ...
                group.className = "btn-group bme-button-group" + num;
                group.id = "bme-button-group" + num + postfix;
            ...
            buttons.redo = makeButton("bme-redo-button", "Redo", redoTitle, "icon-share-alt", null, group4);
            ...
            if (helpOptions) {
                ...
                helpButton.id = "bme-help-button" + postfix;
